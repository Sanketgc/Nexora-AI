...
const Hero = () => {
    ...
    min-h-screen'>
            ...
            <div className='text-center mb-6'>
                <h1 className='text-3x1 sm: text-5x1 md: text-6xl 2xl: text-7x1
            font-semibold mx-auto leading-[1.2]'>Create amazing content <br /> with 
                    <span className='text-primary'> AI tools</span> </h1>
                <p className='mt-4 max-w-xs sm:max-w-1g 2x1 :max-w-x1 m-auto
            ...
            <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
                ...
                hover:scale-102 active: scale-95 transition cursor-pointer'>Start createing now</button>
