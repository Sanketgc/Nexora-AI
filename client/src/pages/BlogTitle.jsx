...
const BlogTitle = () => {
    ...
    const [selectedCtegory, setselectedCtegory] = useState('General')
    ...
    gap-4 text-slate-700 ml-70'>
        ...
        border-gray-200'>
            ...
            text-sm rounded-md border border-gray-300' placeholder='The future of artificial intelligence is ... '
                ...
                <div className='mt-3 flex gap-3 flex-wrap sm:max-w-9/11'>
                    {blogcategories.map((item) => (
                        <span onClick={() => setselectedCtegory(item)}
                            className={`text-xs px-4 py-1 border rounded-full
                    cursor-pointer ${selectedCtegory === item ?
            ...
            bg-linear-to-r from-[#c341f6] to-[#8e37eb] text-white px-4 py-2
