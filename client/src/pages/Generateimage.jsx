...
const Generateimage = () => {
    ...
    const imgstyle = ['Realistic', 'Ghibli style', 'Anime style', 'Cartoon style',
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            // const message = error?.response?.data?.message || error?.message || 'Unable to generate a title right now.';
    ...
    gap-4 text-slate-700 ml-70'>
        ...
        border-gray-200'>
                ...
                <textarea onChange={(e) => setInput(e.target.value)} value={input} rows={4} type="text" className='w-full p-2 px-3 mt-2 outline-none
            text-sm rounded-md border border-gray-300' placeholder='Describe What you Want to see in image' required />
            ...
            bg-linear-to-r from-[#00ad25] to-[#04ff50] text-white px-4 py-2
