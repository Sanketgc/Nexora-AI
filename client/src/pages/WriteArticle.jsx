...
const WriteArticle = () => {
    ...
    const articlelength = [
        { length: 600, text: 'short (500-800 words)' },
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            setLoading(true)
            const prompt = `Write a complete, polished article about ${input}. Create a clear structure with an introduction, 
            several body sections, and a conclusion. Aim for approximately ${selectedlength.length} words. Use natural 
            paragraphs and make the writing detailed, insightful, and easy to read. Do not mention these instructions.`
